...
/**
 * Class CustomerAssignMigration_110
 */
class CustomerAssignMigration_110 extends Migration
{
    /**
    ...
    public function morph()
    {
        $this->morphTable('customer_assign', [
                ...
                'indexes' => [
                    ...
                    new Index('customer_id', ['customer_id'], null),
                    new Index('user_id', ['user_id'], null),
                    new Index('created_by', ['user_created'], null),
                    new Index('updated_by', ['user_updated'], null)
                ],
                'references' => [
                    new Reference(
