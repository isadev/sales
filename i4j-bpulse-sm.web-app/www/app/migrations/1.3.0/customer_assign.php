...
/**
 * Class CustomerAssignMigration_130
 */
class CustomerAssignMigration_130 extends Migration
{
    /**
    ...
    public function morph()
    {
        $this->morphTable('customer_assign', [
                ...
                'indexes' => [
                    ...
                    new Index('customer_assign_ibfk_5', ['sync_status_id'], null)
                ],
                'references' => [
                    new Reference(
