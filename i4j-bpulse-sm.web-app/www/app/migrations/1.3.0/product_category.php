...
/**
 * Class ProductCategoryMigration_130
 */
class ProductCategoryMigration_130 extends Migration
{
    /**
    ...
    public function morph()
    {
        $this->morphTable('product_category', [
                ...
                'indexes' => [
                    ...
                    new Index('product_category_ibfk_4', ['sync_status_id'], null)
                ],
                'references' => [
                    new Reference(
