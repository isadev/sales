...
/**
 * Class InvoiceProductMigration_130
 */
class InvoiceProductMigration_130 extends Migration
{
    /**
    ...
    public function morph()
    {
        $this->morphTable('invoice_product', [
                ...
                'indexes' => [
                    ...
                    new Index('invoice_product_ibfk_5', ['sync_status_id'], null)
                ],
                'references' => [
                    new Reference(
