...
/**
 * Class CustomerContactMigration_130
 */
class CustomerContactMigration_130 extends Migration
{
    /**
    ...
    public function morph()
    {
        $this->morphTable('customer_contact', [
                ...
                'indexes' => [
                    ...
                    new Index('customer_contact_ibfk_4', ['sync_status_id'], null)
                ],
                'references' => [
                    new Reference(
