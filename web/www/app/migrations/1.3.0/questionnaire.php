...
/**
 * Class QuestionnaireMigration_130
 */
class QuestionnaireMigration_130 extends Migration
{
    /**
    ...
    public function morph()
    {
        $this->morphTable('questionnaire', [
                ...
                'indexes' => [
                    ...
                    new Index('questionnaire_ibfk_5', ['questionnaire_type_id'], null),
                    new Index('questionnaire_ibfk_6', ['sync_status_id'], null)
                ],
                'references' => [
                    new Reference(
                    ...
                    new Reference(
                        'questionnaire_ibfk_5',
                        [
                            'referencedTable' => 'questionnaire_type',
                            'referencedSchema' => 'salesDB',
                            'columns' => ['questionnaire_type_id'],
                            'referencedColumns' => ['id'],
                            'onUpdate' => 'NO ACTION',
                            'onDelete' => 'SET NULL'
                        ]
